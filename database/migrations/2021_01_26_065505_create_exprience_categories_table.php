...
class CreateExprienceCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exprience_categories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('exprience_categories');
    }
}
