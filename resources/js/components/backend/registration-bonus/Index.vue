...
export default {
    ...
    created(){
        ...
        this.columnsHead.push('Sn','Title', 'Start Date', 'End Date','Bonus Amount','Description','Photo', 'Status', 'Action')
        this.columnsBody.push('title','start_date','end_date','amount', 'description', 'image', 'statusText')
