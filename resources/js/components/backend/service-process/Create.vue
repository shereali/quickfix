                           ...
                           <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" v-model="inputData.title" class="form-control" placeholder="Enter Title">  
                                </div>
                                <div class="form-group">
                                    <label for="">Step Number</label>
                                    <input type="text" name="step_no" v-model="inputData.step_no" class="form-control" placeholder="Enter Title">  
                                </div>
                                 <div class="form-group"> 
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="description" v-model="inputData.description" id="" class="form-control" cols="2" rows="2"></textarea>
                            </div>
...
created(){
    ...
    this.generalApi = 'service-process'
    this.backUrl = '/service-process'
    this.cardTitle = this.isEdit?'Edit Service Process':'Add New Service Process'   
     this.isFile = true 
    this.isImage = 'image'
