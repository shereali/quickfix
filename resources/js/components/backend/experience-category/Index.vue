...
export default {
    ...
    created(){
        ...
        this.cardTitle ="Experience Category List" 
        this.isFile = true
        this.isImage = 'image'

        this.columnsHead.push('Sn','Title', 'Description', 'image', 'status', 'Action')
        this.columnsBody.push('title', 'description', 'image', 'statusText')
