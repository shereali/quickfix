                           ...
                           <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="device_name" v-model="inputData.device_name" class="form-control" placeholder="Enter Device Name">
                                    </div>
                                    <div class="form-group">
...
created(){
    ...
    this.generalApi = 'device'
    this.backUrl = '/device'
    this.cardTitle = this.isEdit?'Edit Device':'Add New Device' 
    this.isFile = true 
    this.isImage = 'image'
