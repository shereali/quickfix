                           ...
                           <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" v-model="inputData.name" class="form-control" placeholder="Enter Device Functional Type">
                                    </div>
                                    <div class="form-group">
...
created(){
    ...
    this.backUrl = '/device-functional-type'
    this.cardTitle = this.isEdit?'Edit Device Functional Type':'Add New Device Functional Type' 
    this.isFile = true 
    this.isImage = 'image'
