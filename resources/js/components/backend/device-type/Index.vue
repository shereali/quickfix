...
export default {
    ...
    created(){
        ...
        this.dataSearchingApi="search-device-types-data"

        this.cardTitle ="Device Type List"  
        this.isFile = true

        this.columnsHead.push('Sn','Type Name','Status', 'Action')
        this.columnsBody.push('type_name', 'statusText')
