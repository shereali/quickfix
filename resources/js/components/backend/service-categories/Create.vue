                           ...
                           <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" v-model="inputData.description" cols="10" rows="10"></textarea>                                
                                    </div>
                                </div>
                           </div>
                        </div>
...
created(){
    ...
    this.generalApi = 'service-categories'
    this.backUrl = '/service-categories'
    this.cardTitle = this.isEdit?'Edit Service Category':'Add New Service Category' 
    this.isFile = true 
    this.isImage = 'image'
