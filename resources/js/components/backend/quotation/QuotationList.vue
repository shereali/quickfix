...
export default {
    ...
    created(){
        ...
        this.cardTitle ="Quotation List" 

        this.columnsHead.push('Sn','Name', 'Email', 'Phone','Device Name', 'Brand', 'Model', 'Problem')
        this.columnsBody.push('name', 'email', 'phone_number','device_name','brand_name', 'model_number', 'problem')
