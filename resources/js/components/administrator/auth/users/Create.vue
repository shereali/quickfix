                        ...
                        <div class="card-body">
                           <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <v-select :options="roles" :reduce="role => role.id" label="name"  name="role_id" v-model="inputData.role_id" placeholder="Select Role"></v-select>
                                <input type="hidden" name="role_id" v-model="inputData.role_id">
                            </div>
